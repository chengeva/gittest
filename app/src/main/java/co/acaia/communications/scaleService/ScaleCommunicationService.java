...
public class ScaleCommunicationService extends Service {
    ...
    public boolean connect(final String targetBtAddress) {
        ...
        if (mBluetoothDevice.getName().contains("PYXIS") || mBluetoothDevice.getName().contains("CINCO") || mBluetoothDevice.getName().contains("PEARLS") || mBluetoothDevice.getName().contains("ASTRA") || mBluetoothDevice.getName().contains("ASQ")) {
