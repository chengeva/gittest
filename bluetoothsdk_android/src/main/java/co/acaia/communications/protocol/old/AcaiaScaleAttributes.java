package co.acaia.communications.protocol.old;

/**
 * Created by hanjord on 15/3/20.
 */
public class AcaiaScaleAttributes {
    /**
    ...
    public class ECMD {
        ...
        public static final int e_cmd_info_get=13;
        public static final int e_cmd_info_sent=14;
